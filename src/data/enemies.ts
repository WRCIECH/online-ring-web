...
export const ENEMIES: Record<string, Enemy> = {
  procrastination_mob: {
    ...
    max_hp: 80, initiative: 6, max_poise: 20, rune_reward: 50, is_boss: false,
    drops: [
  ...
  hater: {
    ...
    max_hp: 180, initiative: 8, max_poise: 40, rune_reward: 150, is_boss: true,
  ...
  blank_page_omen: {
    ...
    max_hp: 220, initiative: 4, max_poise: 50, rune_reward: 200, is_boss: true,
  ...
  burnout_shade: {
    ...
    max_hp: 100, initiative: 3, max_poise: 25, rune_reward: 60, is_boss: false,
    drops: [
  ...
  comparison_engine: {
    ...
    max_hp: 200, initiative: 8, max_poise: 45, rune_reward: 160, is_boss: true,
  ...
  fear_phantom: {
    ...
    max_hp: 160, initiative: 6, max_poise: 35, rune_reward: 130, is_boss: true,
  ...
  perfectionism_knight: {
    ...
    max_hp: 400, initiative: 10, max_poise: 80, rune_reward: 500,
