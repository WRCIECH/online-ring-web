...
export const CONTENT_TRANSFORMATION_STATS: Record<ContentTransformation, { label: string; stats: StatKey[] }> = {
  ...
  Critique:       { label: 'Critique',       stats: ['FRICTION', 'INSIGHT'] },
  Follows:        { label: 'Follows',        stats: ['VELOCITY'] },
  AudienceShift:  { label: 'Audience Shift', stats: ['PARASOCIAL', 'INSIGHT'] },
  DomainTransfer: { label: 'Domain Transfer',stats: ['DEPTH', 'INSIGHT'] },
  Synthesis:      { label: 'Synthesis',      stats: ['DEPTH', 'TEXT'] },
  RemixFusion:    { label: 'Remix / Fusion', stats: ['INSIGHT', 'VELOCITY'] },
  Split:          { label: 'Split',          stats: ['TEXT', 'VELOCITY'] },
  Evidence:       { label: 'Evidence',       stats: ['DEPTH', 'INSIGHT'] },
  Simplify:       { label: 'Simplify',       stats: ['VELOCITY', 'PARASOCIAL'] },
  Technicalize:   { label: 'Technicalize',   stats: ['DEPTH', 'FRICTION'] },
  Localize:       { label: 'Localize',       stats: ['PARASOCIAL', 'INSIGHT'] },
  Socratic:       { label: 'Socratic',       stats: ['DEPTH', 'INSIGHT'] },
  Analogy:        { label: 'Analogy',        stats: ['PARASOCIAL', 'INSIGHT'] },
  FirstPrinciples:{ label: 'First Principles',stats: ['DEPTH', 'INSIGHT'] },
  DataDriven:     { label: 'Data Driven',    stats: ['INSIGHT', 'GRAPHIC'] },
}
