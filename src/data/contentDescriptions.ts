...
export const DMG_TYPE_INFO: Record<DamageType, ContentEntry> = {
  standard: {
    ...
    label:       'Transparency/Minimalism Style',
  ...
  strike: {
    badge_label: 'Striking',
    label:       'Sensory Shock Style',
  ...
  slash: {
    badge_label: 'Slashing',
    label:       'Narrative/Storytelling Style',
  ...
  pierce: {
    badge_label: 'Piercing',
    label:       'Segmentation/Lists & Rankings Style',
  ...
  fire: {
    badge_label: 'Fiery',
    label:       'Passion/Emotional Expression Style',
  ...
  magic: {
    badge_label: 'Arcane',
    label:       'Intellect/Deep Analysis Style',
  ...
  holy: {
    badge_label: 'Sacred',
    label:       'Solving Problem Focus Style',
  ...
  grafting: {
    badge_label: 'Grafted',
    label:       'Interactivity with Audience Style',
