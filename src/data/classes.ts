...
export const CLASS_DEFINITIONS: ClassDef[] = [
  {
    ...
    startingStats: { VIG:3, END:3, TEXT:1, VIDEO:1, AUDIO:1, GRAPHIC:1, VELOCITY:1, DEPTH:1, PARASOCIAL:1, FRICTION:1, INSIGHT:1 },
  },
  {
    id: 'sprinter',
    name: 'Sprinter',
    ...
    weaponClass: 'daggers',
    startingStats: { VIG:1, END:5, TEXT:0, VIDEO:0, AUDIO:0, GRAPHIC:2, VELOCITY:4, DEPTH:0, PARASOCIAL:0, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'architect',
    name: 'Architect',
  ...
  },
  {
    ...
    startingStats: { VIG:2, END:3, TEXT:0, VIDEO:4, AUDIO:2, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:0, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'orator',
    name: 'Orator',
    ...
    weaponClass: 'torches',
    startingStats: { VIG:2, END:1, TEXT:0, VIDEO:0, AUDIO:4, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:2, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'curator',
    name: 'Curator',
    ...
    weaponClass: 'bows',
    startingStats: { VIG:1, END:2, TEXT:2, VIDEO:0, AUDIO:0, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:0, FRICTION:0, INSIGHT:3 },
  },
  {
    id: 'teacher',
    name: 'Teacher',
    ...
    weaponClass: 'spears',
    startingStats: { VIG:1, END:2, TEXT:0, VIDEO:0, AUDIO:0, GRAPHIC:2, VELOCITY:0, DEPTH:2, PARASOCIAL:2, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'experimenter',
    name: 'Experimenter',
    ...
    weaponClass: 'flails',
    startingStats: { VIG:1, END:4, TEXT:0, VIDEO:2, AUDIO:0, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:0, FRICTION:0, INSIGHT:4 },
  },
  {
    id: 'performer',
    name: 'Performer',
    ...
    startingStats: { VIG:1, END:3, TEXT:0, VIDEO:0, AUDIO:2, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:4, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'polemicist',
    name: 'Polemicist',
    ...
    weaponClass: 'hammers',
    startingStats: { VIG:5, END:2, TEXT:2, VIDEO:0, AUDIO:0, GRAPHIC:0, VELOCITY:0, DEPTH:0, PARASOCIAL:0, FRICTION:4, INSIGHT:0 },
  },
  {
    id: 'aesthete',
    name: 'Aesthete',
    ...
    weaponClass: 'katanas',
    startingStats: { VIG:1, END:2, TEXT:0, VIDEO:2, AUDIO:0, GRAPHIC:2, VELOCITY:0, DEPTH:0, PARASOCIAL:0, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'influencer',
    name: 'Influencer',
    ...
    startingStats: { VIG:3, END:1, TEXT:0, VIDEO:0, AUDIO:0, GRAPHIC:0, VELOCITY:2, DEPTH:0, PARASOCIAL:4, FRICTION:0, INSIGHT:0 },
  },
  {
    id: 'exposer',
    name: 'Exposer',
    ...
    startingStats: { VIG:4, END:1, TEXT:0, VIDEO:0, AUDIO:0, GRAPHIC:0, VELOCITY:0, DEPTH:2, PARASOCIAL:0, FRICTION:3, INSIGHT:0 },
  },
  {
    id: 'prophet',
    name: 'Prophet',
    ...
    weaponClass: 'whips',
    startingStats: { VIG:1, END:1, TEXT:0, VIDEO:0, AUDIO:0, GRAPHIC:0, VELOCITY:2, DEPTH:0, PARASOCIAL:0, FRICTION:2, INSIGHT:2 },
  },
]
