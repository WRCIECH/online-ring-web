...
export const MOB_CURSES: Record<string, MobCurseDef> = {
  ...
  perfectionism_knight: {
    ...
    penalty: { damagePct: 0.25, hpDrainPerTile: 8, staminaCostPerTile: 10 },
  },
}
