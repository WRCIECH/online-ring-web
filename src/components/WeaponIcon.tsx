  ...
  switch (weaponClass) {
    ...
    case 'straight_swords': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,3 L19,40 L16,42 L13,40 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
    ...
    case 'daggers': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,10 L18,34 L16,36 L14,34 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
    ...
    case 'colossal_swords': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,2 L24,38 L16,41 L8,38 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
    ...
    case 'heavy_thrusting': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,3 L17.5,43 L16,45 L14.5,43 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={0.8} {...C}/>
    ...
    case 'curved_swords': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M14,4 Q22,22 20,40 L16,42 L13,40 Q10,22 14,4 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
    ...
    case 'curved_greatswords': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M13,3 Q25,18 22,42 L17,44 L12,42 Q8,18 13,3 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
    ...
    case 'katanas': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M14,3 Q16,20 18,44 L16,46 L15,44 Q13,20 14,3 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
        <ellipse cx="16.5" cy="44" rx="6" ry="2" fill="currentColor" fillOpacity={0.25} strokeWidth={1.5} {...C}/>
    ...
    case 'hammers': return (
      <svg viewBox="0 0 32 56" className={className}>
        <rect x="5" y="6" width="22" height="15" rx="2" fill="currentColor" fillOpacity={0.5} strokeWidth={1.5} {...C}/>
    ...
    case 'halberds': return (
      <svg viewBox="0 0 32 56" className={className}>
        ...
        <path d="M16,3 L13,14 L16,13 L19,14 Z" fill="currentColor" fillOpacity={0.6} strokeWidth={1} {...C}/>
        <path d="M16,18 L5,25 L7,33 L16,30 Z" fill="currentColor" fillOpacity={0.5} strokeWidth={1} {...C}/>
    ...
    case 'torches': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,4 C22,10 22,18 16,22 C10,18 10,10 16,4 Z" fill="currentColor" fillOpacity={0.6} strokeWidth={1} {...C}/>
        <path d="M16,10 C19,14 18,18 16,20 C14,18 13,14 16,10 Z" fill="currentColor" fillOpacity={0.3} strokeWidth={0.5} {...C}/>
        <rect x="13" y="22" width="6" height="30" rx="2" fill="currentColor" fillOpacity={0.35} strokeWidth={1.5} {...C}/>
    ...
    case 'bows': return (
      <svg viewBox="0 0 32 56" className={className}>
        ...
        <path d="M30,23 L27,23 L30,21 Z" fill="currentColor" fillOpacity={0.7} strokeWidth={0.8} {...C}/>
    ...
    case 'greatbows': return (
      <svg viewBox="0 0 32 56" className={className}>
        ...
        <path d="M32,23 L29,22 L32,21 Z" fill="currentColor" fillOpacity={0.7} strokeWidth={0.8} {...C}/>
      </svg>
    )

    case 'great_spears': return (
      <svg viewBox="0 0 32 56" className={className}>
        <path d="M16,2 L12,14 L16,16 L20,14 Z" fill="currentColor" fillOpacity={0.55} strokeWidth={1} {...C}/>
        <line x1="16" y1="14" x2="16" y2="56" strokeWidth={1.5} {...C}/>
    ...
    case 'flails': return (
      <svg viewBox="0 0 32 56" className={className}>
        <rect x="13" y="38" width="6" height="16" rx="2" fill="currentColor" fillOpacity={0.35} strokeWidth={1.5} {...C}/>
        <path d="M16,38 C14,30 20,24 18,16" strokeWidth={1.5} strokeDasharray="3 2" {...C}/>
        <circle cx="18" cy="11" r="5" fill="currentColor" fillOpacity={0.45} strokeWidth={1.5} {...C}/>
    ...
    case 'whips': return (
      <svg viewBox="0 0 32 56" className={className}>
        <rect x="22" y="42" width="6" height="12" rx="2" fill="currentColor" fillOpacity={0.35} strokeWidth={1.5} {...C}/>
